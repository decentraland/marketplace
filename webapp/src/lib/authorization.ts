...
export const useAuthorization = (authorization: Authorization, onFetchAuthorizations: typeof fetchAuthorizationsRequest) => {
  ...
  useEffect(() => {
    if (!isAuthorized(authorization, authorizations) && !hasFetchedAuthorizations.current) {
