...
export const executeOrderRequest = (order: Order, nft: NFT, fingerprint?: string) =>
...
export const executeOrderFailure = (order: Order, nft: NFT, error: string, errorCode?: ErrorCode) =>
