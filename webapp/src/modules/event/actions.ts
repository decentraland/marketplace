...
export const fetchEventRequest = (tag: string) => action(FETCH_EVENT_REQUEST, { tag })
export const fetchEventSuccess = (tag: string, contracts: string[]) => action(FETCH_EVENT_SUCCESS, { tag, contracts })
