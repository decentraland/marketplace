...
/**
 * Checks whether the listing of an NFT is executed, meaning that is currently on rent.
 * @param rental - A rental listing.
...
/**
 * Checks whether the listing of an NFT is open.
 * @param rental - A rental listing.
...
/**
 * Checks whether an ECDSA signature has a valid V.
 * @param signature - A ECDSA signature.
