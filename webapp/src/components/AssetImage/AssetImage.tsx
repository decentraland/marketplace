...
const AssetImage = (props: Props) => {
  ...
  const handleControlActionChange = useCallback(
    async (action: ControlOptionAction) => {
      ...
      if (ControlOptionAction.PLAY_SMART_WEARABLE_VIDEO_SHOWCASE && asset && asset.data.wearable?.isSmart) {
  ...
  return (
    <div className={classes}>
      ...
      <div className="image-wrapper">
        ...
        <AssetImage asset={asset} item={item} onFetchItem={onFetchItem} wallet={wallet} {...rest}>
