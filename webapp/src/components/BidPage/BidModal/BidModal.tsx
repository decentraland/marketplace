...
const BidModal = (props: Props) => {
  const { nft, rental, wallet, authorizations, onNavigate, onPlaceBid, isPlacingBid, getContract } = props
  ...
  const isDisabled = isOwnedBy(nft, wallet) || isInvalidPrice || isInvalidDate || hasInsufficientMANA || isLoading || isPlacingBid
