...
const MintItemModal = (props: Props) => {
  ...
  if (!item.isOnSale) {
    subtitle = (
      <T
        id={'mint_with_mana_page.not_for_sale'}
        values={{
          name,
          secondary_market_link: (
            ...
            >
              {t('mint_with_mana_page.secondary_market')}
            </Link>
          )
        }}
      />
    ...
    subtitle = <T id={'mint_with_mana_page.is_owner'} values={{ name }} />
  } else if (hasInsufficientMANA) {
    subtitle = (
      <T
        id={'mint_with_mana_page.not_enough_mana'}
        values={{
          name,
