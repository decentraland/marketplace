...
import { Props } from './BuyWithManaPage.types'
import './BuyWithManaPage.css'

const BuyWithManaPage = (props: Props) => {
  const { type } = props
  ...
  return (
    <>
      <Navbar isFullscreen />
      <Page className="BuyWithManaPage">
        <WalletProvider>
          {wallet => (
...
export default React.memo(BuyWithManaPage)
