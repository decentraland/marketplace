...
import { getData, getLoading, getRequiredPermissions } from '../../../modules/asset/selectors'
...
const mapState = (state: RootState, ownProps: OwnProps): MapStateProps => {
  ...
  return {
    isLoading: isLoadingType(getLoading(state), FETCH_SMART_WEARABLE_REQUIRED_PERMISSIONS_REQUEST),
