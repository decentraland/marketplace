...
const SearchBarDropdownOptionSkeleton = ({ shape = 'rect', lines = 2 }: SearchBarDropdownOptionSkeletonProps) => {
  return (
    <div className={styles.skeletonContainer} data-testid={SKELETONS_DATA_TEST_ID}>
      <div className={classNames(styles.assetImageSkeleton, shape === 'rect' ? styles.rectangle : styles.circle)} />
