...
import { switchNetworkRequest, SwitchNetworkRequestAction } from 'decentraland-dapps/dist/modules/wallet/actions'
...
export type MapStateProps = Pick<Props, 'isBuyNftsWithFiatEnabled' | 'isBuyWithCardPage'>
